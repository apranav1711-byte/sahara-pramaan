...
Vercel subsequently reported the Git-linked `main` revision [`ff9790c`](https://github.com/apranav1711-byte/sahara-pramaan/commit/ff9790c06a5dc1bfefd24f33e3f5cdd2d66e03a5), **feat: respect system theme with smooth transitions**, as Ready. A direct browser session on the public alias then observed the **Dark mode** switch, activated the low-light palette, and retained the independent/synthetic-only disclosure treatment.
